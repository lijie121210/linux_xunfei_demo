...
{
        FILE *file = fopen("wav/result.txt","w");
...
int main(int argc, char* argv[])
{
	...
	const char* login_params			=	"appid = 563199a8, work_dir = ."; // 登录参数，appid与msc库绑定,请勿随意改动
...
//
	...
	*/
	...
	run_iat("wav/coco.wav", session_begin_params); //iflytek02音频内容为“中美数控”；如果上传了用户词表，识别结果为：“中美速控”。
exit:
	printf("按任意键退出 ...\n");
	getchar();
	MSPLogout(); //退出登录
